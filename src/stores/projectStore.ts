...
export const useProjectStore = defineStore('projectStore', () => {
  ...
  function getInterviewByMoment (momentId: string) {
      const moment = repo.Moment.find(momentId)
      if (moment) {
          return getInterview(moment.interviewId)
      } else {
          return null
      }
  }
  ...
  function importProject (data: any, url: string, clear: boolean = true) {
    ...
    console.log("Imported", { project: out, url, clear })
    return out
  }
